...
class DBMasterTable(Base):
    ...
    children_replay = relationship(
        "DbReplayTable", lazy="immediate", back_populates="parent"
    )
    children_strat = relationship(
        "DbStratTable", lazy="immediate", back_populates="parent"
    )
    children_config = relationship(
        "DbConfigTable", lazy="immediate", back_populates="parent"
    )
    children_raw = relationship("DbRawTable", lazy="immediate", back_populates="parent")
...
class DbReplayTable(Base):
    ...
    parent = relationship(
        "DBMasterTable", lazy="immediate", back_populates="children_replay"
    )
...
class DbStratTable(Base):
    ...
    master_table_id = Column(Integer, ForeignKey("master.unique_id"))
    parent = relationship(
        "DBMasterTable", lazy="immediate", back_populates="children_strat"
    )
...
class DbConfigTable(Base):
    ...
    master_table_id = Column(Integer, ForeignKey("master.unique_id"))
    parent = relationship(
        "DBMasterTable", lazy="immediate", back_populates="children_config"
    )
...
class DbRawTable(Base):
    ...
    master_table_id = Column(Integer, ForeignKey("master.unique_id"))
    parent = relationship(
        "DBMasterTable", lazy="immediate", back_populates="children_raw"
    )
    children_param = relationship(
        "DbParamTable", lazy="immediate", back_populates="parent"
    )
    children_outcome = relationship(
        "DbOutcomeTable", lazy="immediate", back_populates="parent"
    )
...
class DbParamTable(Base):
    ...
    parent = relationship(
        "DbRawTable", lazy="immediate", back_populates="children_param"
    )
...
class DbOutcomeTable(Base):
    ...
    iteration_id = Column(Integer, ForeignKey("raw_data.unique_id"))
    parent = relationship(
        "DbRawTable", lazy="immediate", back_populates="children_outcome"
    )
